...
<head>
  ...
  <title>Dashbord - Digitalent</title>

  <link href="_assets/css/bootstrap.min.css" rel="stylesheet" />
  <link rel="stylesheet" href="_assets/css/color-style.css" />
</head>

<body style="background-color: #718792">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li>
            <a href="_logout.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a>
          </li>
        </ul>
      </div>
    </div>
