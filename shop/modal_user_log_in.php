...
<div id="modal-log-in" class="modal fade" role="dialog">
            ...
            <div class="modal-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="account block">
                        ...
                        <h3 class="titular">SIGN IN TO YOUR ACCOUNT</h3>
                        ...
                        <a class="fb-sign-in" href="58">
                            <p><span class="fb-border"><span class="icon zocial-facebook">F</span></span>Sign in with Facebook</p>
                        </a>
                    </div>
